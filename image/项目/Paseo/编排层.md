...
| aura-agent  | https://github.com/erickong/aura-agent                                                                      |     |
| skill       | https://github.com/K-Dense-AI/scientific-agent-skills                                                       |     |
| vibe-coding | https://github.com/arpingblue/vibepm                                                                        |     |
| 长时间run      | https://github.com/pranshuparmar/witr                                                                       |     |
...
| mindmap | https://github.com/ZM-BAD/DAG-chat                                                                 |     |
| ai内容营销  | https://github.com/yikart/AiToEarn                                                                 |     |
| agent   | https://github.com/tinyhumansai/openhuman                                                          |     |
| react   | https://github.com/millionco/react-doctor                                                          |     |
| 知识图谱    | https://github.com/colbymchenry/codegraph                                                          |     |
...
## **Regex（正则表达式）**：在输出前/后自动修改文本。例如：自动过滤 AI 的废话，或者将特定的口癖替换掉。
