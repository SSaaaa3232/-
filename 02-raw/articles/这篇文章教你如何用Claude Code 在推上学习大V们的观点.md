---
title: "这篇文章教你如何用Claude Code 在推上学习大V们的观点"
source: "https://x.com/PandaTalk8/status/2039972807833219415"
author:
  - "[[@PandaTalk8]]"
published: 2026-04-03
created: 2026-04-07
---
我最常用的一个方法就是把X上一些大V们的发表内容下载下来用AI分析一遍，学习他们高观点和他们的思维。

**利用XClawl 在 Claude Code 整理 Karpathy 的发表内容**
...
## 把 XCrawl 包装成 Claude Code Skill
...
> xcrawl search "site: [x.com](https://x.com/) karpathy" --limit 20 --country US --language en --json

![[9c1d18aec216b835d8e74f74b3edd002_MD5.jpg]]

Claude Code 会自动调用 XCrawl Skill 执行搜索。几秒钟后，你会拿到这样的结构化数据：

![[ab04d8cee472ca35f2db79c3084de4b3_MD5.jpg]]
...
> "用同样的方法，帮我采集以下博主关于 AI 的推文，每人 20 条：[@dotey](https://x.com/@dotey)（中文 AI 圈意见领袖）、[@AndrewYNg](https://x.com/@AndrewYNg)（教育向）、[@levie](https://x.com/@levie)（企业 AI 应用）、[@MatthewBerman](https://x.com/@MatthewBerman)（AI 工具评测）"
...
> "把刚才采集的所有博主推文数据整理一下： 按话题分类（AI 编程、AI Agent、创业、教育、思维模型） 每个话题提取 top 5 最有价值的观点 标注每条观点的出处博主和原文链接 生成一份《AI 行业观点周报》保存到 ai-weekly.md"

Claude Code 会自动读取所有采集结果、分类整理、生成报告。全程你只需要说话，不用敲一行命令。

## 实际采集结果展示

用上面的方法，我从 Karpathy 的 20 条推文中整理出了以下核心观点：
...
![[5f3a07d0a57be5463fed11e7c615b8d5_MD5.png]]
...
> **注册 XCrawl 送 1,000 免费 credits，不绑卡 →** [xcrawl.com](https://xcrawl.com/?keyword=mejyxnjh)