...
- 陷阱：
	- 
	- 验证标准不明确，就是自欺欺人。（有的时候回直接根据大小判断或者实效不纠错重启）
...
- 适用：
	- 
	- 大型代码库迁移，每个 Agent 负责一块独立服务。

- 陷阱：
	- 
	- Agent 之间如果共享资源，可能会冲突。
...
- 陷阱：
	- 
	- 调试难，一个告警经过 5 个 Agent，出事了追链路很痛苦。
...
- 适用：
	- 
	- 多 Agent 联合研究，一个人的发现另一个人直接用。

- 陷阱：
	- 
	- 反应式循环——A 写了，B 读了再写，A 又读又写，无限烧 token。
