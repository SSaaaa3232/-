...
created: 2026-04-04
description: "前两天突发奇想：一个生产级的 agentic CLI 到底需要哪些组件？每一层的具体怎么实现？SSE 缓冲区怎么管理、system prompt 怎么分段、工具权限怎么拦截、上下文满了怎么压缩。这些问题靠读文档回答不了，靠逆向混淆代码效率极低。所以选择了另一条路：以 Claude..."
tags:
  - "clippings"
modified: 2026-04-07
---
...
![Image](https://pbs.twimg.com/media/HEgGP82aQAAZIbQ?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HEgGVl2aMAAdxGd?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HEgGXr3bAAAVFVf?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HEgGZudacAApmOM?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HEgGu9VbgAANTTd?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HEgHkekaoAAaxxu?format=jpg&name=large)
