...
created: 2026-04-07
description: "OpenAI Codex 团队的产品规格文档只有 10 个要点。不是说每个功能的文档只有 10 个要点，而是整个产品的 spec 就这么多。设计师写的代码量超过了六个月前工程师写的。50 到 100 人的团队，直到最近才有了第二个产品经理。这些数字来自 OpenAI Codex ..."
---
...
![[a17c36408ac736b8b85faabdff7973ca_MD5.jpg]]
...
![[1e42466f7874714808764e654ee6907d_MD5.jpg]]
...
> 我们在 Codex 团队写的 spec 非常非常少。就算写，也就十来个要点，就这样了。 （“We write very, very few specs on the Codex team. We're talking like 10 bullets or something, and then that's it.”）我们在 Codex 团队写的 spec 非常非常少。就算写，也就十来个要点，就这样了。 （“我们在 Codex 团队写的规格非常非常少。大概十发子弹之类的，然后就没了。”）
...
![[bc6ece5e7726f2ad8d846db46e0fc460_MD5.jpg]]
...
> 对于一个小改动来说，直接提一个好的 PR，往往比找人沟通、让他们在一万件事情里把这件排上优先级要快得多。 （“For a small change, it's often faster to send a PR than it is to communicate to someone and get them to prioritize that task when they have 10,000 other things to do.”）对于一个小改动来说，直接提一个好的 PR，往往比找人沟通、让他们在一万件事情里把这件排上优先级要快得多。 （“对于一个小变化，发公关通常比联系别人让他们优先处理任务要快，因为他们还有一万件事要做。”）
...
![[c97e339f6c05522210d29d500df18998_MD5.jpg]]

谈到设计师角色，Alex 说：

> Codex 团队的设计师现在写的代码量，超过了六个月前一个工程师写的代码量。 （“The designers on the Codex team write more code now than was written by an engineer six months ago.”）Codex 团队的设计师现在写的代码量，超过了六个月前一个工程师写的代码量。 （“Codex 团队的设计师现在写的代码比六个月前工程师写的还多。”）
...
![[42b33a0445f8b3143dfe2b5bfa9fdd40_MD5.jpg]]
...
> 我们最前沿的用户和我们一起住在未来，还把我们往未来拽。 （“The cutting edge of your users are just absolutely living in the future with us and pulling us into that future.”）我们最前沿的用户和我们一起住在未来，还把我们往未来拽。 （“你们用户的前沿成员就是和我们一起生活在未来，把我们拉进那个未来。”）

![[c8dbefda4e4601f3bfff8a0a4c161e09_MD5.jpg]]
...
![[afecae3fbff684f93b832decf005c6fa_MD5.jpg]]
...
![[8fd4d2579c7d11ccbaf9580349bee3dc_MD5.jpg]]
...
> 我其实不认为 PM 是一个好的领导岗位。我觉得它是一个填补空缺的岗位。 （“I don't actually view PM as a good leadership position. I view it as a fill-in-the-gaps position.”）我其实不认为 PM 是一个好的领导岗位。我觉得它是一个填补空缺的岗位。 （“我其实并不认为项目经理是一个好的领导职位。我认为这是一个填补空白的职位。”）
...
> 做任何事情所需的人越少，那件事就做得越好。每个决策都更纯粹。 （“I think the fewer people you need in a room to do anything, just the better that thing goes. The more pure every decision is.”）做任何事情所需的人越少，那件事就做得越好。每个决策都更纯粹。 （“我觉得一个房间里需要的人越少，事情就越顺利。每个决定越纯粹。”）
...
![[a62c38e44f3bec82a8a9ef7ddb5eaf05_MD5.jpg]]
...
![[c29c366613d1c1f5973bc968270a1aea_MD5.jpg]]

看求职信息时，他优先看对方发来的**链接和想法**。如果有人写了一堆自我介绍和简历，他大概率不会读完。他说他完全不知道团队成员是什么学校毕业的。

> 我很高兴我们生活在一个那些愚蠢的证书不再重要的世界里。管它什么学校呢。给我看你做了什么。 （“I'm so glad we live in a world where all these stupid credentials don't matter anymore. Who cares? Show me what you built.”）我很高兴我们生活在一个那些愚蠢的证书不再重要的世界里。管它什么学校呢。给我看你做了什么。 （“我真庆幸我们生活在一个这些愚蠢的资历不再重要的世界。谁在乎呢？给我看看你做了什么。”）

Romain 补充了开发者体验团队的招聘标准：技术强、工具熟练、同时热爱和开发者社区在一起、喜欢教别人。他提到他们刚宣布 Thomas（Codex Monitor 开源项目的创建者）将加入他的团队。

> Thomas 即 Thomas Ricouard（[@Dimillian](https://x.com/@Dimillian)），知名开源开发者，构建了 Codex Monitor，一个用 Codex 为 Codex 开发的开源监控应用。Romain 在推特上确认了这一加入。
