---
name: "source-command-save-skill"
...
# source-command-save-skill

Use this skill when the user asks to run the migrated source command `save-SKILL`.
...
- Not: "The user asked about X and Codex explained..."
