---
name: "source-command-wiki-skill"
description: "Codex + Obsidian knowledge companion. Sets up a persistent wiki vault, scaffolds structure from a one-sentence description, and routes to specialized sub-skills. Use for setup, scaffolding, cross-project referencing, and hot cache management. Triggers on: \"set up wiki\", \"scaffold vault\", \"create knowledge base\", \"/wiki\", \"wiki setup\", \"obsidian vault\", \"knowledge base\", \"second brain setup\", \"running notetaker\", \"persistent memory\", \"llm wiki\"."
---

# source-command-wiki-skill

Use this skill when the user asks to run the migrated source command `wiki-SKILL`.

## Command Template

# wiki: Codex + Obsidian Knowledge Companion
...
- Query: ask any question: Codex reads index first, then drills in
...
This is the force multiplier. Any Codex project can reference this vault without duplicating context.
