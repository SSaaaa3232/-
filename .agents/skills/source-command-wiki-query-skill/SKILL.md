---
name: "source-command-wiki-query-skill"
...
# source-command-wiki-query-skill

Use this skill when the user asks to run the migrated source command `wiki-query-SKILL`.
