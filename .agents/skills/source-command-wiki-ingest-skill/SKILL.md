---
name: "source-command-wiki-ingest-skill"
...
# source-command-wiki-ingest-skill

Use this skill when the user asks to run the migrated source command `wiki-ingest-SKILL`.
...
1. **Read** the image file using the Read tool. Codex can process images natively.
