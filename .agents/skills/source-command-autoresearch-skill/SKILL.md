---
name: "source-command-autoresearch-skill"
...
# source-command-autoresearch-skill

Use this skill when the user asks to run the migrated source command `autoresearch-SKILL`.
