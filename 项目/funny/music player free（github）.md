...
1\. Go to the link: https://github.com/lyswhut/lx-music-desktop…  

  
Click on 2.12.1 on the right to access the download link  

  
For MacBook, it's .dmg

For Windows, there are labels for 32-bit and 64-bit

For Linux, it's .deb, .AppImage, .pacman  
对于 MacBook 来说，.dmg

对于 Windows，有 32 位和 64 位标签

对于 Linux 来说，就是.deb， 。AppImage，.pacman  
  
2\. After installation, click Settings → Basic Settings → Simplified Chinese  

  
3\. At this point, searching for songs won't work; you need to add a music source  

  
Settings → Custom Sources → Import Online  
设置→自定义源→在线导入  
