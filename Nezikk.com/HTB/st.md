...
| SMB        | A protocol used to share files, printers, and other resources in a network                                                                                                                                                                                                                     |           |
...
| OSPF       | It is an interior gateway protocol (IGP) for routing traffic within a single Autonomous System (AS) in an Internet Protocol (IP) network.                                                                                                                                                      |           |
...
| NNTP       | NNTP is a protocol used for distributing and retrieving messages in newsgroups across the internet.                                                                                                                                                                                            |           |
...
| SIP        | It is a signaling protocol used for establishing and terminating real-time voice, video and multimedia sessions over an IP network.                                                                                                                                                            |           |
...
| ms-sql-m   | Used for the Microsoft SQL Server Browser service.                                                                                                                                                                                                                                             | 1434      |
...
| DHCP       | It is used to assign IP addresses to devices in a network dynamically.                                                                                                                                                                                                                         | 67        |
| BOOTP      | It is used to bootstrap hosts in a network.                                                                                                                                                                                                                                                    | 500       |
